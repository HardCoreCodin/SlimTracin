...
<img src="src/examples/XPU.png" alt="XPU" width="580">
...
* <b><u>Implicit Geometry</b>:</u> Quad, Box, Sphere and Tetrahedra, all with UV-based transparency<br>
  ...
  <img src="src/examples/02_Geometry_setup.png" alt="02_Geometry_setup" width="580">
  <img src="src/examples/02_Geometry_transparency.png" alt="02_Geometry_transparency" width="580">
* <b><u>Point lights</b>:</u> Can be moved around and scaled (changing their light intensity)<br>
  ...
  <img src="src/examples/01_Lights_setup.png" alt="01_Lights_setup" width="580">
* <b><u>Area Lights</b>:</u> Emissive quads can be used as rectangular area lights<br>
  ...
  <p float="left">   
    ...
    <img src="src/examples/06_AreaLights_selection.png" alt="06_AreaLights_selection" width="380">
  </p>  
* <b><u>Classic Materials</b>:</u> Lambert, Blinn, Phong<br>
  <img src="src/examples/03_BlinnPhong.gif" alt="03_BlinnPhong"><br>
  <p float="left">
    <img src="src/examples/03_BlinnPhong_setup.png" alt="03_BlinnPhong_setup" width="380">
...
* <b><u>PBR Materials</b>:</u> Cook-Torrance BRDF (Schlick/Smith GGX)<br>
  ...
  <img src="src/examples/05_PBR.png" alt="05_PBR" width="580">
* <b><u>Reflective/Refractive Materials</b>:</u> For glasses and mirrors (bounce count is controlled globally)<br>
  ...
  <p float="left">   
    <img src="src/examples/04_GlassMirror_setup.png" alt="04_GlassMirror_setup" width="380">
...
* <b><u>Meshes</b>:</u> Transformable and can have smooth shading using vertex normal interpolation<br>
  ...
  <p float="left">
    ...
    <img src="src/examples/07_Meshes_init.png" alt="07_Meshes_init" width="380">
  </p>
...
* <b><u>Textures</b>:</u> Albedo, Normal<br>
  ...
  <img src="src/examples/09_Textures.png" alt="09_Textures" width="580"><br>
...
* <b><u>Render Modes</b>:</u> Beauty, Depth, Normals, UVs and BVHs<br>
  ...
  <p float="left">
    ...
    <img src="src/examples/08_Modes_setup.png" alt="08_Modes_setup" width="380">
  </p>
